...
// A1, in flight in parallel); until that lands, pinta-gemini vendors an
// identical copy so the M5b/M5e scanner has a contract to implement against.
// Do NOT diverge from the plan's shape here — when @pinta-ai/core@^0.4.0 is
