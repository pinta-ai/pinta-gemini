...
//   - tools/install-hooks.ts manifest version  (generated gemini-extension.json)
//
...
const targets = [
  // GUARD_UA = 'pinta-gemini/<version>' (quote style + adaptor name preserved)
  ...
  // gemini-extension.json generator: { name: EXT_NAME, version: "<version>", ... }
  { file: 'tools/install-hooks.ts', re: /(name: EXT_NAME, version: ")[^"]+(")/, to: `$1${version}$2` },
];
